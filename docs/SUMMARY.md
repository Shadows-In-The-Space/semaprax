...
- [Paired coding-agent pilot — 13 September 2026](AGENT-TASK-PILOT-2026-09-13.md)
- [Authentication host v1](AUTHENTICATION-HOST-V1.md)
- [Compact semantic projection: model-text v2](COMPACT-SEMANTIC-PROJECTION-V2.md)
- [Embedding API v2](EMBEDDING-API-V2.md)
- [HTTPS Client I/O v2](HTTPS-CLIENT-IO-V2.md)
- [Model Call Adapter Evidence v1](MODEL-CALL-ADAPTER-EVIDENCE-V1.md)
- [Model Call Invoice Import v1](MODEL-CALL-INVOICE-IMPORT-V1.md)
- [Model Call Journal Receipt v1](MODEL-CALL-JOURNAL-RECEIPT-V1.md)
