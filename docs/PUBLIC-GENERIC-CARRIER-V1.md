...
52 physical processes: both branch selections and requires true/false through
C11/C++17 at O0/O2, each with canonical, wrong-path and legacy-flat inputs
(48), plus four checked-call-to-identity-stub omission controls. Non-palindromic
