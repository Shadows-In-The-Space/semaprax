...
static COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec { id: CommandId::Registry, canonical: "registry", aliases: &[], availability: Availability::Public, global: true, usages: &["semaprax registry search <registry.json> <query>", "semaprax registry add <registry.json> <package> <range>", "semaprax registry lock <registry.json> <template.json>", "semaprax registry fetch <registry.json> <package> <version>", "semaprax registry verify <registry.json> <snapshot-evidence.json>", "semaprax registry verify <registry.json> <template.json> <lock-evidence.json>", "semaprax registry publish <registry.json> <entry.json>"] },
