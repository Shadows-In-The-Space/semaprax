...
three `Rust 1.88 minimum` shards failed. Those selectors pass locally and are
wired into CI, but until a run completes with a Rust lane green they are local
evidence, not hosted evidence.
