...
| `semaprax` inside a tag archive | The [v0.5.0 prerelease](https://github.com/wavect/semaprax/releases/tag/v0.5.0) archives | The archive's `semaprax` *is* the `semaprax-full` binary, renamed during staging, so archive users write `semaprax doctor`, not `semaprax-full doctor`. |
...
The [v0.5.0 prerelease](https://github.com/wavect/semaprax/releases/tag/v0.5.0)
...
Expected shapes, from a local `0.5.0` standalone build:

```text
semaprax 0.5.0 (commit unknown)
```
