...
pub use native_emit::{
    emit_c_with_filesystem_io, emit_c_with_filesystem_io_v2, emit_c_with_filesystem_io_v3,
    emit_c_with_https_io, emit_c_with_network_io, emit_hir_c_with_filesystem_io,
    emit_hir_c_with_filesystem_io_v2, emit_hir_c_with_filesystem_io_v3, emit_hir_c_with_https_io,
